...
const AIPredictions: React.FC<AIPredictionsProps> = ({ symbol, data }) => {
    const [selectedPeriod, setSelectedPeriod] = useState<"1W" | "2W" | "1M">(
        "1W"
    );
    ...
    const predictions = {
        ...
        mediumTerm: {
            ...
            targetPrice: parseFloat(
                data.summary.weeklyOutlook.targetRange.split("-")[1] || "0"
            ),
            timeframe: "1 Month",
        },
        longTerm: {
            direction:
                data.monthlyPredictions?.[data.monthlyPredictions.length - 1]
                    ?.direction || "Neutral",
            confidence:
                data.monthlyPredictions?.[data.monthlyPredictions.length - 1]
                    ?.confidence || 0,
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-gray-700 p-4 rounded-lg">
                            <div className="text-center">
                                <div className="text-sm text-gray-400 mb-2">
                                    {predictions.shortTerm.timeframe}
                                </div>
                                <div
                                ...
                                <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                                    <div
                                        ...
                                        style={{
                                            width: `${predictions.shortTerm.confidence}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                        ...
                        <div className="bg-gray-700 p-4 rounded-lg">
                            <div className="text-center">
                                ...
                                <div className="text-2xl font-bold text-white mt-2">
                                    ${predictions.mediumTerm.targetPrice}
                                </div>
                                <div className="text-sm text-gray-400 mt-2">
                                    Confidence:{" "}
                                ...
                                <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                                    <div
                                        className="bg-green-400 h-2 rounded-full transition-all duration-300"
                                        style={{
                                            width: `${predictions.mediumTerm.confidence}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                        ...
                        <div className="bg-gray-700 p-4 rounded-lg">
                            <div className="text-center">
                                <div className="text-sm text-gray-400 mb-2">
                                    {predictions.longTerm.timeframe}
                                </div>
                                <div
                                    className={`text-lg font-semibold ${getDirectionColor(
                                ...
                                <div className="text-2xl font-bold text-white mt-2">
                                    ${predictions.longTerm.targetPrice}
                                </div>
                                <div className="text-sm text-gray-400 mt-2">
                                    Confidence:{" "}
                                ...
                                <div className="w-full bg-gray-600 rounded-full h-2 mt-2">
                                    <div
                                        ...
                                        style={{
                                            width: `${predictions.longTerm.confidence}%`,
                                        }}
                                    ></div>
                                </div>
                            </div>
                            ...
                            {signals.map((signal, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`text-sm font-medium ${signal.color}`}
                                        >
                                            {signal.strength}
                                        </span>
                                    </div>
                    ...
                    <div className="mt-4 p-3 bg-yellow-900/20 border border-yellow-500/30 rounded-lg">
                        <div className="text-xs text-yellow-400">
                            ...
                            based on historical data and should not be used as
                            sole investment advice. Always consult with
